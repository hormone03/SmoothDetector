...
if reshuffle_data:
    ...
    df_train = pd.read_csv("weibo/processedData/df_train.csv")
    df_test = pd.read_csv("weibo/processedData/df_test.csv")
    ...
    df_minority = df_marged[df_marged['label']==1]
    print(f"df_minority: {len(df_minority)}")
    df_majority = df_marged[df_marged['label']==0]
    ...
    df_train_s.to_csv('weibo/df_train2.csv', encoding='utf-8', index=False)
    df_test_s.to_csv('weibo/df_test2.csv', encoding='utf-8', index=False)
    df_train = pd.read_csv("weibo/df_train2.csv")
    df_test = pd.read_csv("weibo/df_test2.csv")
    ...
    df_train_s.to_csv('weibo/df_train3.csv', encoding='utf-8', index=False)
    df_test_s.to_csv('weibo/df_test3.csv', encoding='utf-8', index=False)
    df_train = pd.read_csv("weibo/df_train3.csv")
    df_test = pd.read_csv("weibo/df_test3.csv")
    print(f"length of training set: {len(df_train)}")
    print(f"length of test set: {len(df_test)}")
...
transformed_dataset_train = FakeNewsDataset(df_train, root_dir, image_transform, tokenizer, MAX_LEN)
